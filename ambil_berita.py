...
# --- PROMPT GAYA PULNEW - SUDAH DIBERSIHKAN ---
def prompt_rewrite_umum(title, konten_asli, link):
    ...
    2. Buat 3 paragraf. Pisahkan dengan 1 baris kosong.
    3. Buat 2 Subjudul. Pakai format Markdown: ## Nama Subjudul
...
def rewrite_with_groq(title, link, media):
    ...
    if not GROQ_API_KEY or not konten_asli or len(konten_asli) < 150:
        return f"Baca selengkapnya di {media}", soup
    ...
    try:
        ...
        return hasil.strip(), soup # LANGSUNG KEMBALIKAN MENTAH
    except Exception as e:
        print(f"Error Groq: {e}")
        return konten_asli[:500], soup
        ...
        try:
            ...
            for item in soup.find_all('item')[:3]:
                ...
                berita_data = {
                    ...
                    "image": img_url,
                    "body": body, # INI SEKARANG TEKS MENTAH/MARKDOWN
